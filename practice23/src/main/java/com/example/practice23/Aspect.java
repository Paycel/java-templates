...
import com.example.practice23.services.EmailService;
import com.example.practice23.models.Gameable;
...
public class Aspect {
    ...
    @Pointcut("within(com.example.practice23.services.*)")
    ...
    @Pointcut("execution(* com.example.practice23.services.*.save(..))")
