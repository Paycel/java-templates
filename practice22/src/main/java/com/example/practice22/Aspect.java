...
import com.example.practice22.services.EmailService;
import com.example.practice22.tables.Gameable;
...
public class Aspect {
    ...
    @Pointcut("within(com.example.practice22.services.*)")
    ...
    @Pointcut("execution(* com.example.practice22.services.*.save(..))")
